...
- 主机
	...
	- 主板
		- LGA 1151（支持英特尔14nm CPU）
			- 部分H110、B150主板（可能带D3、DDR3后缀）支持便宜的DDR3的AMD专用条（内存），要省钱的话优先考虑，搜“H110 DDR3”（以下为部分型号，按接口兼容性（以及可靠性）降序，都有PS/2接口，只有VGA接口的老办公主板就不列了）
				- H110（无M.2接口）
					- 华硕H110M-PLUS D3（VGA、DVI、HDMI、COM；闲鱼没搜到）
					- 华硕TROOPER H110 D3（VGA、DVI、COM）
					- ==华硕H110M-K D3（VGA、DVI；闲鱼这种较多，所以与二三线品牌的没啥价差甚至更便宜；110）==
					- 技嘉H110M-DS2V DDR3(rev.1.0)（VGA、DVI；PS/2接口是单个键鼠通用）
					- ---
					- 华硕H110M-E D3（VGA、HDMI、COM）
					- 华硕H110M-D D3（VGA、HDMI、COM；PS/2接口是单个键鼠通用；闲鱼没搜到）
				- B150（无特别说明则有M.2接口）
					- ==技嘉B150M-DS3H DDR3(rev.1.0)（VGA、DVI、HDMI、COM；PS/2接口是单个键鼠通用；129）==
					...
					- ==技嘉B150M-D3V DDR3(rev.1.0)（VGA、DVI；PS/2接口是单个键鼠通用；有M.2接口，可能比华硕H110M-K D3更值；119）==
		...
		- 交流电
			- DC供电
			  id:: 68e31fb3-8d06-493a-b716-7b78e9c09c3e
				...
				- DC-ATX
					- [如何将笔记本电源接入台式机主板？ - 知乎](https://www.zhihu.com/question/469388741)
