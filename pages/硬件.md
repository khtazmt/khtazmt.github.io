...
- 主机
	...
	- 主板
		- LGA 1151（支持英特尔14nm CPU）
			- 部分H110主板支持相对便宜的DDR3内存（可能带D3、DDR3后缀），要省钱的话优先考虑，搜“H110 DDR3”（以下为部分型号，按接口兼容性降序，都有PS/2接口，只有VGA接口的老办公主板就不列了）
				- 华硕H110M-PLUS D3（VGA、DVI、HDMI、COM；闲鱼没看到）
				- 华硕TROOPER H110 D3（VGA、DVI、COM）
				- 华硕H110M-K D3（VGA、DVI；闲鱼最多的是这种，所以与二三线品牌的没啥价差甚至更便宜）
				- 技嘉H110M-DS2V DDR3(rev.1.0)（VGA、DVI；PS/2接口是单个键鼠通用）
				- 华硕H110M-E D3（VGA、HDMI、COM）
				- 华硕H110M-D D3（VGA、HDMI、COM；PS/2接口是单个键鼠通用）
			- 部分B250主板支持AMD多显卡交火，但可能意义不大（？）
