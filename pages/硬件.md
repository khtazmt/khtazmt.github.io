		...
		- LGA 1151（支持英特尔14nm CPU）
			- 部分H110、B150主板（可能带D3、DDR3后缀）支持便宜的DDR3的AMD专用条（内存），要省钱的话优先考虑，搜“H110 DDR3”（以下为部分型号，按接口兼容性（以及可靠性）降序，都有PS/2接口，只有VGA接口的老办公主板就不列了）
				...
				- B150（无特别说明则有M.2接口）
					...
					- ==技嘉B150M-D3V DDR3(rev.1.0)（VGA、DVI；PS/2接口是单个键鼠通用；有M.2接口，多2个USB 3.0、SATA接口，可能比华硕H110M-K D3更值；119）==
				...
				- DC 12V电源
					- 服务器电源
					  id:: 68e7be9a-6598-4bdc-b7f6-ab4adf8b0106
						...
						- [服务器Crps电源和CSPS电源的区别 - 唐软](https://www.itangsoft.com/baike/show-167001.html)
						- CRPS电源
