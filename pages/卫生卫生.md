			...
			- 运动种类和市场的细分
				- ((666a2d18-eaf0-4cd5-b61a-dedeecaf51bd)) 、工业化劳动分工、竞技体育、好莱坞、坐标系、选拔性体育教育/培养体系、电脑手机与 ((66a5b524-eee4-428a-83c3-3ba5df70224b))
				  id:: 66a6b955-20e3-46df-8d50-22267d330a58
					- “强和美比小大，所以大就是强和美”
			- 动吃医体系关键词：fitness（muscle）、structure、function、movement
				- isolation、holistic
				- practical
				- natural、primal（paleo）
				- keto
			  ...
			  collapsed:: true
				- [筋膜训练—关于抓毛巾的一些细节_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1mM4y1P7n9)
				  id:: 666ccf00-49a1-42c4-8c63-2619e7ce4610
					...
					- 从轻到重（像是举重，无论力量有多大，都从较小的重量慢慢往上加），
					- 初学者保守练建议不要练到开抖的程度，以免受伤
						- 动作标准了像第二个视频那样开抖不是问题，但动作标准并不意味着你有那样的水平使动作标准，或者动作标准时动作的难度相同，好比举不同重量，动作都差不多标准，
					- 宁可动作不那么完整也不要感到疼痛
...
- # 钱
  ...
  collapsed:: true
	...
	- 膳食指南等包含的相对健康的饮食习惯和健康中国包含在实际传播中，并不如，可能消费者个体的“人性”，市场条件下盈利，但也不能否认，国家也不太可能强力推广这些可能对“相对有害但能维持市场经济的习惯”而不顾就业和税收而去，除非危机已经到了必须让一部分利益集团妥协的地步
	- 外币
	  collapsed:: true
		- 世界主导货币（）发行国对其他国家征收的铸币税
			- “世界分配是这样的，发展中国家的劳动者们只需要不停工作就可以了，发达国家的银行家、企业家、消费者们要考虑的就很多了”
			- 2008年的金融危机后，美元持续大量发行以延缓更大的金融危机，货（币）多不值钱，应该贬值，但美元的币值很大程度上靠全球（大头是中国）购买的美国国债托底，作为继续参与世界市场的条件
			- “你不用有的是国家不敢不用”
			- 铸币税
				- [通俗且直击重点：美元潮汐如何收割全球 大家往往都听过，美国通过加息降息人为制造金融浪潮，在美元的外扩与回流中利用铸币税收割世界。但这一长串字背后只描述了一个广... - 雪球](https://xueqiu.com/4603145397/279006583)
			- 定价权
				- 基于资源（贷款等资金、大宗商品等原料、市场、科技等；即便军事实力占优，开第一枪与开第二枪还是有不小区别的）控制和军事实力
			- 购买力
	...
	- 税收
	  collapsed:: true
		- 运行官僚机构
		- 为贫困的中长期失业者提供，抽象体现为对提供巨大剪刀差的农业人口的兜底
		- 超企业的基础设施建设
		- 定向税收优惠等措施帮助实现进口卡脖子替代、
		- ---
		- “如果都去吃初级农产品了，谁来吃垃圾食品呢？”
	- 保险
	  collapsed:: true
		- “（海专）精算”后的集体定向存款
		- 社会保险
