...
- # 运动
  id:: 65bef01e-6c50-489b-8678-edc291a9be9e
	...
	- 运动的风险、安全性
		...
		- 修剪指甲趾甲
		- 空间足够（不一定有）
		- 踏空（玻璃桌面）、摔倒（重心不够稳固，踏上去翘起来翻了）、碰倒（瑜伽球附近至少两米内）、掀翻（）、抽离（桌布）、撞墙角（爬行时顾头不顾尾，撞墙角拉到脚趾）
		- 门框要注意是否牢固
	...
	- 保险
	  collapsed:: true
		...
		- 商业医疗险/健康险等
			...
			- 拒赔
				- 多因素强制归为单因素
					- 出院小结可能会写几项病症，保险公司可能参考保险合同，因为出院小结（家属急着出院）中有一项病症含有“先天”字样就拒赔，但实际治疗的可能只是其中一部分——当然完全可以说实际治疗的病症是由含“先天”字样病症导致的
					- 因为什么入院，医生可以改
	- 资本
	  collapsed:: true
		- 利息
