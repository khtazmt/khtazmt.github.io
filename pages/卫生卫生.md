  ...
  id:: 65b4fa7e-6b77-4f99-828b-314335481c79
	...
	- DOING 有症状后的流程
	  ...
	  :END:
		...
		- 我的建议
			- 呼吸道传染病的传染主要来自三密（密切：靠得近；密集：人多；密闭：不太通风）场合——当然，只要不是“（独自）家里蹲”或“淡季游”，也是很常见的场合
			- 判断大类（“好像算是呼吸道症状”），
			- 处理
				- 使用自测抗原自测
					- 拖到医院还是测几项，或者不测直接开一堆“大礼包”吃了完事，其中还可以有较多比较贵且自付比例高的中成药，还增加了院感风险，之后不确定要不要等结果出来，一次可能测不准，那么可以一次性从多部位采样
				- 阳性了吃抗病毒药（如果愿意赌，也可以吃不良反应较小的抗病毒药），盐水（可以用高渗盐水，如果阳性也可以用次氯酸之类，我还不太习惯）
				- 洗鼻漱口漱喉，补剂吃一吃，没吃饱的话吃点东西，尤其是蛋白质可以适度多吃
					- 说明：这些措施在短期基本上是有益无害的
					- 而在急性期至少要避免保暖工作不完善的洗浴和晒太阳，并要避免中高强度的运动
				- 睡眠
					- 睡眠一般有助，尤其在缺乏睡眠的情况下，但在睡前如果未及时采取足够的正确的处理措施，也可能拖延病情，那么的确要加上更多角度的诊断
