...
- “回归教程”
	...
	- K光影（可以增加服务器的负担，效果还不一定让你满意），L进度（游戏、模组的推荐游玩目标序列，一般会跳过不少）
	- 右击床重设重生点，在夜晚可跳过夜晚（多人在线时需要多人一起躺）
	- ---
	- 出生点北偏东15度左右走两三百米左右是我们的村庄
		- 村里有个传送石碑，点上，在矿道下面下界传送门旁边还有一个，点上后就可以两地传送了
		  id:: 662e5b99-edbc-4a6e-82a3-951482ff4146
		- 箱子里可能有的土豆加农炮、铜背罐、土豆（可以九个合成一个箱装马铃薯，反过来可以分解）都带着，铜背罐装备到胸甲位置，作为压缩气罐，可以给土豆加农炮供能、不减耐久，与潜水头盔配合可以水下呼吸15分钟
		- 遇到拿弩的怪可以快跑走位躲箭，可以进屋蹲门
		- 服务器开了死亡掉落保护，所以（一般）不用担心怪叫和意外死亡
	...
	- 制作
		- 各种机壳
			- 砧板上右键放原木右键用斧子劈（可以在物品栏挨一起，提高手动效率——“坏了，”）得去皮原木，然后放在地上（“把咱村的土径压坏了”）用对应的材料锭右键
		- 精密