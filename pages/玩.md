...
- “搜”
	- [[藏]]
		...
		- 撤
			- “为啥要撤？我不能不走了在这当家做主吗？就是分批进图也比带着无根的虚拟商品撤好吧？”
				...
				- 边缘世界Rimworld
				  ...
				  collapsed:: true
					...
					- [序一.基础设置及讲解【环世界1.6纯原版教学】_环世界_实况解说](https://www.bilibili.com/video/BV17ce7zLESW/)
						- “辩证地看待，有选择地看待”，比如可以一落地就尽快切大理石走起，房间合理分区，而不是规划优先于现时需求
					...
					- 生产
						- 订单
							- 较大量的生产是计划经济，先把订单（与生产设备绑定，订单做完了找人微操也无法生产）、排班安排好省事，而不是看缺啥要做啥了找人微操
						- 特定生产
							- 屠宰
								- 用允许屠宰的角色在有屠宰订单的屠宰台等右键优先屠宰（如果不优先屠宰），而不是右键拖尸体（可能拖不了）
					- 命令
					- 品质
						- 很多产品（不包括结构）和服务都有品质（使用价值）上的差异
...
- 有工具
  collapsed:: true
	...
	- 非加工工具
	  id:: 69004919-6e26-443d-9c2f-e151a84690f4
	  collapsed:: true
		- TODO （薯片）罐（伞）绳传声筒
		- “可食用玩具”
