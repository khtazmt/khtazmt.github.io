		  ...
		  collapsed:: true
			...
			- 酸面团酵头（sourdough starter）
				...
				- 参考菜谱
					...
					- [My Easy GUIDE To Making A SOURDOUGH STARTER | How To Make A Sourdough Starter from scratch - YouTube](https://www.youtube.com/watch?v=xSR2jW2W8hc)
				...
				- 发酵容器
				  collapsed:: true
					- 可以用旋盖或压盖（按盖）的足够宽、平内壁（便于去除上部面糊）玻璃罐
				- 清洁、消毒发酵容器和搅拌工具
				  collapsed:: true
